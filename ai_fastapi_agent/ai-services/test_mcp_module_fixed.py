"""
Fixed Comprehensive Tests for MCP (Model Context Protocol) Medical Agent
Tests every function and user contextual data storage functionality
Handles LangGraph initialization issues gracefully
"""
...
class TestMCPUserContextualDataStorage:
    ...
    async def test_complete_user_context_storage(self):
        ...
        with patch.object(MCPMedicalAgent, '_create_agent_graph', return_value=None):
            ...
            assert "asthma" in updated_state["current_context"]["current_context"]["profile"]["medical_history"]
            ...
            # Verify summary contains all key information
            ...
            assert "135/85" in summary
            assert "142 mg/dL" in summary
